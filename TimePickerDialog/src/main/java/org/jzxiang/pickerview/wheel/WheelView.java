...
package org.jzxiang.pickerview.wheel;
...
import org.jzxiang.pickerview.adapters.WheelViewAdapter;
import org.jzxiang.pickerview.config.DefaultConfig;
import org.jzxiang.pickerview.config.PickerConfig;
...
public class WheelView extends View {
    ...
    private void initData(Context context) {
        ...
        mPaintLineCenter.setColor(DefaultConfig.TV_SELECTOR_COLOR);
        ...
        mPaintRectCenter.setColor(DefaultConfig.TV_NORMAL_COLOR);
    ...
    public void setConfig(PickerConfig config) {//选择中间的背景色
        mPaintLineCenter.setColor(config.mWheelTVNormalColor);

        mPaintRectCenter.setColor(config.mWheelTVNormalColor);
        mPaintRectCenter.setAlpha((int) (0.1 * 255));
